...
Insertion Sort curves upward much faster than Merge and Quick, matching **O(n²)** vs **O(n log n)**. Merge and Quick stay low on this scale; their gap is small here. Shading shows run-to-run spread (random input).
